...
const bilanCtrl = require('../controllers/bilanBT')
...
// router.get('/mic/quantities-per-products', bilanCtrl.getQuantitiesPerProductsAsMIC)
// router.get('/mic/quantities-per-marketers', check.ifMarketerOrMICOrDPB, bilanCtrl.getQuantitiesPerMarketersAsMIC)
...
router.get('/mic/quantities-per-products/:startDate/:endDate', bilanCtrl.getQuantitiesPerProductsAsMIC)
...
// router.post('/get-perequationss',  bilanCtrl.getFtms)
